...
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		final String TESTFILE01 = "resources/findIDs_test2.txt";	// Example test file for hashing based on IDs
		final String TESTFILE02 = "resources/findGenres_test2.txt"; // Example test file for hashing based on genres names
